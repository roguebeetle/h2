// Класс импорта таблиц paradox в sqlite3
...
public class pdx2sqlite {
    //Глобальные структуры и переменные
    public List<String> AddressData = new ArrayList<>();
    public List<String> Data = new ArrayList<>();
    String sqliteDbNname = "jdbc:sqlite:db/sqlite/kipdb.sqlite";
    String paradoxDbName = "jdbc:paradox:db/paradox";
    Connection c = null;
    Statement stmt = null;
...
//Рабочие методы
    public void createSQLiteTables() {
        try {
            ...
            c = DriverManager.getConnection(sqliteDbNname);
    ...
    public void cloneParadoxAddressDataToList(){
        try {
            ...
            c = DriverManager.getConnection(paradoxDbName);
    ...
    public void cloneAddressDataToSQLiteObjects(){
        try {
            Class.forName("org.sqlite.JDBC");
            c = DriverManager.getConnection(sqliteDbNname);
            c.setAutoCommit(false);
    ...
    public void cloneDataListToSQLiteObjects(){
        try {
            Class.forName("org.sqlite.JDBC");
            c = DriverManager.getConnection(sqliteDbNname);
            c.setAutoCommit(false);
    ...
    public void dbFileDel(){
        File file = new File("db/sqlite/kip.db");
        file.delete();
    }
}
